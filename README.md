...
<p align="center">
  ...
  <a href="https://github.com/SofiaKapsiani/FLIMPA/releases/tag/v1.3.1">
    FLIMPA (v1.3.1) </a> **
</p>
...
FLIMPA can be easily run on Windows using the <a href="https://github.com/SofiaKapsiani/FLIMPA/releases/tag/v1.3.1" title=".exe" download>.exe</a> file. Alternatively, you can clone the GitHub repository and run the software following these steps:
